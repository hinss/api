...
import (
	...
	model "github.com/hinss/api/goodserver/v1"
	"gorm.io/gen"
	"gorm.io/gen/field"
)
...
func newCategory(db *gorm.DB) category {
	...
	_category.IsTab = field.NewBool(tableName, "is_tab")
	_category.URL = field.NewString(tableName, "url")
	_category.AddTime = field.NewTime(tableName, "add_time")
	_category.IsDeleted = field.NewInt32(tableName, "is_deleted")
...
func (c *category) updateTableName(table string) *category {
	...
	c.IsTab = field.NewBool(table, "is_tab")
